...
const ProjectCard = ({profile, loading, getData}) => {
        ...
        >
          {!profile?.projects || profile?.projects?.length === 0 ? (
            <Flex align="center">
              ...
              <Avatar size={150} src={"https://www.topcv.vn/v3/profile/profile-png/profile-project.png"} shape="square" style={{marginLeft: "auto"}} className="ml-5"/>
            </Flex>
          ) : (
